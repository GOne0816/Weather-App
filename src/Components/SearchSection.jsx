  ...
  return (
    <div>
      <div className="flex items-center gap-3">
        ...
        <button className="flex justify-center items-center active:bg-white/20 rounded-lg backdrop-blur-md border border-transparent active:border active:border-white/50 aspect-square w-14">
